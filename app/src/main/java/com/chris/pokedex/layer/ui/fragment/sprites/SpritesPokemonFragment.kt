package com.chris.pokedex.layer.ui.fragment.sprites

import android.os.Bundle
import android.view.View
import com.chris.pokedex.databinding.SpritesPokemonFragmentBinding
import com.chris.pokedex.layer.model.PokemonModel
import com.chris.pokedex.utils.Constants
import com.chris.pokedex.utils.base.BaseViewBindingFragment

class SpritesPokemonFragment :
    BaseViewBindingFragment<SpritesPokemonFragmentBinding>(SpritesPokemonFragmentBinding::inflate) {

    companion object {
        fun newInstance(pokemonModel: PokemonModel) = SpritesPokemonFragment().apply {
